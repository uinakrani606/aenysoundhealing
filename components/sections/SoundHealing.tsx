    ...
    return (
        <>
            <section className="w-full mx-auto max-w-335 sm:px-5 px-4">
                <div className="relative overflow-hidden rounded-lg border border-border/20 bg-[radial-gradient(at_0%_0%,rgb(26,117,103)_0%,rgb(5,61,53)_100%)] p-8 md:p-10 text-white shadow-card">
                    ...
                    <div className="absolute right-8 top-6 text-7xl opacity-10">
                        {/* <Image src={Instragram} alt="Instagram Icon" className="w-20 h-20" aria-hidden="true" /> */}
                        ◎
                    </div>

                    <div className="relative z-10">
                        <span className="inline-flex items-center rounded-full bg-glass px-4 py-2 text-small backdrop-blur-md border border-white/10">
                            Instagram Profile
                        </span>
                        <h2 className="mt-5 text-heading-lg font-bold text-accent">
                            Let's Connect
                        </h2>
                        ...
                        <p className="mt-5 max-w-xl text-body text-muted leading-relaxed">
                            Follow me on Instagram for creative work, updates,
                            behind-the-scenes content and daily inspiration.
                        </p>
                        <div className="mt-8 flex flex-wrap gap-4">
                            <a
                                ...
                                className="inline-flex items-center gap-2 rounded-md bg-accent px-6 py-3 font-semibold text-dark-green transition-all duration-300 hover:-translate-y-1 hover:shadow-soft"
                            >
                                Connect on Instagram →
                            </a>
                            <div className="rounded-md border border-white/10 bg-glass px-5 py-3 backdrop-blur-md">
        ...
        //                 <h2 className='text-white text-center xl:text-[60px] md:text-[42px] sm:text-[28px] text-xl font-semibold leading-[1.2] sm:mb-10 mb-5'>
